			...
			<nav class="sb-sidenav accordion sb-sidenav-light"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						</a><a class="nav-link" href="insertMenu.do">
							<div class="sb-nav-link-icon">
								<svg class="svg-inline--fa fa-gauge-high" aria-hidden="true"
									focusable="false" data-prefix="fas" data-icon="gauge-high"
									role="img" xmlns="http://www.w3.org/2000/svg"
			...
			<main>
				...
				<center>
					<table border="1" cellpadding="0" cellspacing="0" width="800">
						<tr>
							<td align="center" width="30"><b>회원아이디</b></td>
							<td align="center" width="60"><b>회원이름</b></td>
							<td align="center" width="60"><b>회원등록일</b></td>
							<td align="center" width="80"><b>회원등급</b></td>
							<td align="center" width="60"><b>탈퇴</b></td>
							<td align="center" width="80"><b>탈퇴여부</b></td>
							<td align="center" width="60"><b>등급 변경</b></td>
						</tr>
						<c:forEach var="member" items="${memberList}">

							<tr>
								<td align="center">${member.uid}</td>
								<td align="center">${member.name}</td>
								<td align="center">${member.reg_date}</td>
								<td align="center">${member.level }</td>
								<td align="center"><a
									href="deleteMember2.do?id=${member.uid}">탈퇴</a></td>
								<td align="center">${member.withdraw}</td>
								<td align="center"><a
									href="updateLevel.do?id=${member.uid }">등급변경</a></td>
							</tr>
						</c:forEach>
					</table>
				</center>
