...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav">
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<a class="nav-link" href="NoticeList.do">
							...
							<a class="nav-link" href="selectMember.do?uid=${sessionScope.id}">
							<div class="sb-nav-link-icon">
						...
						<a class="nav-link" href="deleteMember.do?id=${sessionScope.id}">
							<div class="sb-nav-link-icon">
								<svg class="svg-inline--fa fa-gauge-high" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="gauge-high" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                    <path fill="currentColor" d="M0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zM288 96a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM256 416c35.3 0 64-28.7 64-64c0-17.4-6.9-33.1-18.1-44.6L366 161.7c5.3-12.1-.2-26.3-12.3-31.6s-26.3 .2-31.6 12.3L257.9 288c-.6 0-1.3 0-1.9 0c-35.3 0-64 28.7-64 64s28.7 64 64 64zM176 144a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM96 288a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm352-32a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z">
                                    </path>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="card mb-4">
					<div class="card-body">
						<center>
							<div id="form"><!-- action="updateMember.do" -->
								<form  method="post" id="updform" action="updateMember.do">
									<h1>회원 정보 수정</h1>
									<table border="1" cellpadding="0" cellspacing="0"
										style="width: 600px;">
										<input type="hidden" name="uid" value="${member1.uid} ">
										<br>
										<tr>
											<td>비밀번호</td>
										...
										<tr>
											...
											<td><input type="text" id="name" name="name"
												style="width: 185px" value="${member1.name}"></td>
										</tr>
										<tr>
											<td>이메일</td>
											<td><input type="text" id="email" name="email"
												style="width: 185px" value="${member1.email}"></td>
										</tr>
										<tr>
											<td>전화번호</td>
											<td><input type="text" id="phone" name="phone"
												style="width: 185px" value="${member1.phone}"></td>
										</tr>
									</table>
									<br><button class="btn btn-primary" id="btn">회원수정</button>
									<!-- onclick="btn_submit()" -->
								</form>
							</div>
						</center>
		...
		<c:choose>
			<c:when test="${sessionScope.id ne member1.uid}">
				<script>
					alert("잘못된 접근입니다.");
