...
<style>
    ...
    height: 100px; /* 원하는 크기로 조정하세요 */
    padding: 0; /* 내부 패딩 제거 */
    border-radius: 0; /* 둥근 모서리 제거 */
    /* 기타 스타일링 옵션을 추가할 수 있습니다. */
}
</style>
<meta charset="utf-8">
			...
			<form id="frm">
				<h1>로그인</h1>
					<table border="1" cellpadding="0" cellspacing="0"  style="width: 450px;">
						<tr>
							<td for="uid">아이디</td>
							<td><input type="text" id="uid" name="uid" style="width: 94%;"></td>
							<td rowspan="2" align="center"><button type="button" class="btn btn-primary square-btn"  id="btn_submit">로그인</button></td>
						</tr>
						<tr>
							<td for="pwd">비밀번호</td>
							<td><input type="password" id="pwd" name="pwd" style="width: 94%;"></td>
						</tr>
					</table>
				<br>
				<button type="button" class="btn btn-light"  onclick="window.open('find_id_form.do', 'window_name', 'width=430, height=500, location=no, status=no, scrollbars=yes');">아이디찾기</button>
				<button type="button"  class="btn btn-light" onclick="window.open('find_password_form.do', 'window_name', 'width=430, height=500, location=no, status=no, scrollbars=yes');">비밀번호찾기</button>
				<br>
				<br>
								<button type="button"  class="btn btn-primary" onclick="location.href='insertMember.do' ">회원가입</button>
			</form>
		</div>
	</center>
	<c:if test="${sessionScope.id ne null}">
