				...
				<div class="card mb-4">
					...
					<form action="insertMenu.do" method="post">
						<table>
							<tr>
								<td>년도</td>
								<td align="left"><input name="myear" type="text" size="8"
									value="" /></td>
							</tr>
							<tr>
								<td>월</td>
								<td align="left"><input name="month" type="text" size="8"
									value="" /></td>
							</tr>
							<tr>
								<th>이미지</th>
	...
	<script type="text/javascript">
		...
		function showUploadImage(uploadResultArr) {
			...
			if (bodyArray.length > 0) {
				...
				let fileCallPath = uploadPath.replace(/\\/g, '/') + "/s_"
						+ uuid + "_" + fileName;
				console.log("ㅎㅇ2");
				str += "<div id='result_card'>";
				str += "<img style='width:300px;height:500px;' src='display2.do?fileName=" + fileCallPath + "'>";
				...
				console.log("No 'uploadPath' found in the JSON data.");
			}
